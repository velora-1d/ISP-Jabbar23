<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center space-x-4">
            <a href="{{ route('users.index') }}" class="p-2 rounded-lg hover:bg-gray-700/50 transition-colors text-gray-400 hover:text-white">
            ...
            <div>
                ...
                <p class="text-gray-400 text-sm mt-1">Create a new team member account</p>
            </div>
        </div>
    </x-slot>
            ...
            <div class="rounded-2xl bg-gradient-to-br from-gray-800/80 to-gray-900/80 border border-gray-700/50 backdrop-blur overflow-hidden shadow-2xl">
                <div class="p-8">
                    ...
                    <form method="POST" action="{{ route('users.store') }}" class="space-y-6">
                        ...
                        <!-- Role Selection -->
                        <div>
                            <label for="role" class="block text-sm font-semibold text-gray-300 mb-2">Assign Role / Jabatan</label>
                            <div class="relative">
                                <div class="absolute inset-y-0 left-0 flex items-center pl-4 pointer-events-none">
                        ...
                        <div class="flex items-center justify-end space-x-4 pt-6 border-t border-gray-700/50">
                            <a href="{{ route('users.index') }}" class="px-6 py-3 text-sm font-semibold text-gray-400 hover:text-white transition-colors">
                                Cancel
                            </a>
