<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center space-x-4">
            <a href="{{ route('packages.index') }}" class="p-2 rounded-lg hover:bg-gray-700/50 transition-colors text-gray-400 hover:text-white">
            ...
            <div class="rounded-2xl bg-gray-800 border border-gray-700 overflow-hidden shadow-2xl">
                <div class="p-8">
                    ...
                    <form method="POST" action="{{ route('packages.update', $package) }}" class="space-y-6">
                        ...
                        <!-- Package Name -->
                        <div>
                            <label for="name" class="block text-sm font-semibold text-gray-300 mb-2">Package Name</label>
                            <div class="relative">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <!-- Download Speed -->
                            <div>
                                <label for="speed_down" class="block text-sm font-semibold text-gray-300 mb-2">Download (Mbps)</label>
                                <div class="relative">
                                    <div class="absolute inset-y-0 left-0 flex items-center pl-4 pointer-events-none">
                                        <svg class="w-5 h-5 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 14l-7 7m0 0l-7-7m7 7V3"></path></svg>
                                    </div>
                                    <input type="number" id="speed_down" name="speed_down" value="{{ old('speed_down', $package->speed_down) }}"
                                        class="w-full pl-12 pr-4 py-3 bg-gray-900/50 border border-gray-700 rounded-xl text-white placeholder-gray-500 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all" 
                            ...
                            <!-- Upload Speed -->
                            <div>
                                <label for="speed_up" class="block text-sm font-semibold text-gray-300 mb-2">Upload (Mbps)</label>
                                <div class="relative">
                                    <div class="absolute inset-y-0 left-0 flex items-center pl-4 pointer-events-none">
                                        <svg class="w-5 h-5 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 10l7-7m0 0l7 7m-7-7v18"></path></svg>
                                    </div>
                                    <input type="number" id="speed_up" name="speed_up" value="{{ old('speed_up', $package->speed_up) }}"
                                        class="w-full pl-12 pr-4 py-3 bg-gray-900/50 border border-gray-700 rounded-xl text-white placeholder-gray-500 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all" 
                        ...
                        <!-- Price -->
                        <div>
                            <label for="price" class="block text-sm font-semibold text-gray-300 mb-2">Monthly Price (Rp)</label>
                            <div class="relative">
                                <div class="absolute inset-y-0 left-0 flex items-center pl-4 pointer-events-none">
                        ...
                        <!-- Description -->
                        <div>
                            <label for="description" class="block text-sm font-semibold text-gray-300 mb-2">Description (Optional)</label>
                        ...
                        <div class="flex items-center">
                            ...
                            <label for="is_active" class="ms-2 text-sm text-gray-400">Set as Active (visible to customers)</label>
                        </div>

                        <!-- Action Buttons -->
                        <div class="flex items-center justify-end space-x-4 pt-6 border-t border-gray-700">
                            <a href="{{ route('packages.index') }}" class="px-6 py-3 text-sm font-semibold text-gray-400 hover:text-white transition-colors">
                                Cancel
                            </a>
