    ...
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <div>
                ...
                <p class="text-gray-400 text-sm mt-1">Manage your bandwidth plans and pricing</p>
            </div>
            <a href="{{ route('packages.create') }}" class="inline-flex items-center px-5 py-2.5 text-sm font-semibold text-white bg-gradient-to-r from-blue-600 to-cyan-500 rounded-xl hover:from-blue-700 hover:to-cyan-600 focus:ring-4 focus:ring-blue-500/30 transition-all duration-200 shadow-lg shadow-blue-500/25">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                ...
                <div class="p-4 rounded-xl bg-gray-800 border border-gray-700">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            <p class="text-2xl font-bold text-white">{{ $packages->where('is_active', true)->count() }}</p>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="relative group">
                    ...
                    <div class="relative p-6 bg-gray-800 rounded-2xl border border-gray-700">
                        ...
                        <p class="text-gray-400 text-sm mb-4 line-clamp-2">{{ $package->description ?? 'No description' }}</p>
                        ...
                        <div class="flex items-end justify-between">
                            ...
                            <div class="flex space-x-2">
                                <a href="{{ route('packages.edit', $package) }}" class="p-2 rounded-lg hover:bg-gray-700 transition-colors text-gray-400 hover:text-white">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path></svg>
                                </a>
                                <form action="{{ route('packages.destroy', $package) }}" method="POST" onsubmit="return confirm('Yakin hapus paket ini?')">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit" class="p-2 rounded-lg hover:bg-red-500/20 transition-colors text-gray-400 hover:text-red-400">
                ...
                <div class="col-span-full">
                    <div class="text-center py-12 bg-gray-800 rounded-2xl border border-gray-700">
                        ...
                        <a href="{{ route('packages.create') }}" class="inline-flex items-center px-4 py-2 text-sm font-semibold text-white bg-blue-600 rounded-lg hover:bg-blue-700 transition-colors">
                            <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"></path></svg>
                            Add Package
                        </a>
                    </div>
