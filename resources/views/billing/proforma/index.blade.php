...
<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
            ...
            <p class="text-gray-400 mt-1">Kelola quotation dan pra-tagihan pelanggan</p>
        </div>
        <a href="{{ route('billing.proforma.create') }}" class="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-fuchsia-600 to-pink-600 hover:from-fuchsia-500 hover:to-pink-500 text-white font-semibold rounded-xl transition-all duration-200 shadow-lg shadow-fuchsia-500/25">
    ...
    <div class="bg-gray-800/50 backdrop-blur-xl rounded-2xl border border-gray-700/50 p-6">
        <form method="GET" class="flex flex-wrap gap-4 items-end">
            <div class="flex-1 min-w-[200px]">
                ...
                <select name="status" class="w-full bg-gray-700/50 border border-gray-600 rounded-xl px-4 py-2.5 text-white focus:ring-2 focus:ring-fuchsia-500 focus:border-transparent">
            ...
            <button type="submit" class="px-6 py-2.5 bg-gradient-to-r from-fuchsia-600 to-pink-600 hover:from-fuchsia-500 hover:to-pink-500 text-white font-semibold rounded-xl transition-all duration-200">
                Filter
            </button>
            <a href="{{ route('billing.proforma') }}" class="px-6 py-2.5 bg-gray-700 hover:bg-gray-600 text-white font-semibold rounded-xl transition-all duration-200">
                Reset
            </a>
        </form>
    </div>
            ...
            <table class="w-full">
                <thead class="bg-gray-900/50">
                    <tr>
                        ...
                        <th class="px-6 py-4 text-left text-xs font-semibold text-gray-400 uppercase">Berlaku Sampai</th>
                ...
                <tbody class="divide-y divide-gray-700/50">
                    ...
                    <tr class="hover:bg-gray-700/30 transition-colors">
                        <td class="px-6 py-4">
                            <a href="{{ route('billing.proforma.show', $proforma) }}" class="text-fuchsia-400 hover:text-fuchsia-300 font-medium">
                                {{ $proforma->proforma_number }}
                            </a>
                        </td>
                        <td class="px-6 py-4">
                            <div class="flex items-center gap-3">
                                <div class="w-8 h-8 rounded-full bg-gradient-to-br from-fuchsia-500 to-pink-600 flex items-center justify-center text-white text-sm font-semibold">
                        ...
                        <td class="px-6 py-4">
                            <span class="px-3 py-1 rounded-full text-sm font-medium bg-{{ $proforma->status_color }}-500/20 text-{{ $proforma->status_color }}-400">
                                {{ $proforma->status_label }}
                            </span>
                        </td>
                        <td class="px-6 py-4 text-right">
                            <a href="{{ route('billing.proforma.show', $proforma) }}" class="inline-flex items-center gap-1 px-3 py-1.5 bg-fuchsia-600/20 hover:bg-fuchsia-600/40 text-fuchsia-400 rounded-lg transition-colors">
