        ...
        <div class="bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 text-gray-100">
                <div class="flex justify-between items-center mb-6">
                    <h2 class="text-xl font-semibold text-white">ODP Management</h2>
                    <a href="{{ route('network.odps.create') }}" class="px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white rounded-lg">
                        + Add New ODP
                    </a>
                </div>
                        ...
                        <tbody>
                            ...
                            <tr class="border-b border-gray-700 hover:bg-gray-700/50">
                                ...
                                <td class="px-6 py-4 flex gap-2">
                                    <a href="{{ route('network.odps.edit', $odp) }}" class="text-blue-400 hover:text-blue-300">Edit</a>
                                    <form action="{{ route('network.odps.destroy', $odp) }}" method="POST" onsubmit="return confirm('Delete ODP?');">
                                        @csrf @method('DELETE')
